...
<body>
    ...
    <div class="container">
        ...
        ?>
        <form action="../controller/transaksi_act.php" method="POST">
                ...
                <div class="col-lg-3">
                    ...
                    <select name="anggota" id="anggota" class="form-select">
                        ...
                        ?>
                            ...
                            <option <?php echo (@$row['anggota'] == @$value['id']) ? 'selected' : ''; ?> value="<?= $value["id"] ?>"><?= $value['nama']; ?> [<?= $value["id_anggota"]; ?>]</option>
                        <?php
                        }
                        ?>
                    </select>
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-3">
                    ...
                    <select name="buku" id="buku" class="form-select">
                        ...
                        ?>
                            <option <?php echo (@$row['buku'] == @$value['id']) ? 'selected' : ''; ?> value="<?= $value["id"] ?>"><?= $value['judul_buku']; ?> [<?= $value["isbn"]; ?>]</option>
                        <?php
                        }
                        ?>
                    </select>
