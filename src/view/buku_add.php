...
<body>
    ...
    <div class="container mt-4">
        ...
        ?>
        <form action="../controller/buku_act.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row mb-4">
                <div class="col-lg-4">
                    ...
                    <a href="buku_read.php" class="btn btn-warning"><i class="fa-solid fa-left-long"></i> Kembali</a>
                </div>
            </div>
        </form>
    </div>
